...
* TABLAS 55 MOVIMIENTO DE GANADO
...
*==============================================================================*.
*Indicaciones.
*1- Descargue la Bases de datos de movimiento de ganado"vglnac2025" de la página web: http://www.ecuadorencifras.gob.ec//estadisticas-agropecuarias-2/#

*2- Guarde la base y copie el directorio en:.
*get file = 'C:\....\vglnac2025.sav'.

*==============================================================================*.
*                            CONSTRUCCIÓN DE LA TABLA 54
                                  *
*==============================================================================*.
...
CTABLES
  /VLABELS VARIABLES=vm_tn vm_trs vm_trc vm_tro vm_znd ual_prov DISPLAY=NONE  /VLABELS VARIABLES=TOTAL 
    subtotal_machos vgv_ncmterne vgv_ncmtoret vgv_ncmtoros subtotal_hembras 
    vgv_nchterne vgv_nchvacon vgv_nchvacas
    DISPLAY=LABEL
  /TABLE vm_tn + vm_trs + vm_trc + vm_tro + vm_znd+ ual_prov BY TOTAL [SUM] + subtotal_machos [SUM] + 
    vgv_ncmterne [SUM] +  vgv_ncmtoret [SUM] + vgv_ncmtoros [SUM] + subtotal_hembras [SUM] + 
      vgv_nchterne [SUM] + vgv_nchvacon [SUM] + vgv_nchvacas [SUM]
  /SLABELS VISIBLE=NO
  ...
  /TITLES
    ...
    'TABLA 54. NÚMERO DE CABEZAS DE GANADO VACUNO VENDIDAS, SEGUN REGIÓN Y PROVINCIA' 
